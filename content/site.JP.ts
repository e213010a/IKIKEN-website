export const site = {
  ...
  aboutPage: {
    ...
    collaborators: {
      ...
      title: "臨床の現場から、伴走する医師たち。",
      body: "内視鏡医・外科医として、トレーニング設計や医学的妥当性の検証、研究デザインとエビデンス形成を支えるクリニカル・コラボレーターです。",
    },
    advisors: {
      eyebrow: "Advisors",
      title: "技術と事業を、外部から支える。",
      body: "手術ロボティクスや医工連携研究、海外展開など、技術・事業戦略の観点から助言するアドバイザーです。",
    },
    teamNote:
  ...
  recruitPage: {
    hero: {
      eyebrow: "Recruit",
      title: "医療DXの未来を、\n一緒につくる仲間へ。",
      body: "医療継承研究所は、医療とテクノロジーの両方に本気で向き合うチームです。\n内視鏡トレーニングのあり方を変える挑戦に、力を貸してください。",
    },
    culture: {
      eyebrow: "Culture",
      title: "私たちが大切にしていること",
  ...
  cta: {
    ...
    body: "プロダクトについてのご質問、導入に関するご相談など、\nどんなことでもお気軽にお問い合わせください。\n担当者より折り返しご連絡いたします。",
